...
public final class GreeterGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<oracle.demo.grpc.protobuf.helloworld.Helloworld.HelloRequest,
      oracle.demo.grpc.protobuf.helloworld.Helloworld.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = oracle.demo.grpc.protobuf.helloworld.Helloworld.HelloRequest.class,
      responseType = oracle.demo.grpc.protobuf.helloworld.Helloworld.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<oracle.demo.grpc.protobuf.helloworld.Helloworld.HelloRequest,
      oracle.demo.grpc.protobuf.helloworld.Helloworld.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<oracle.demo.grpc.protobuf.helloworld.Helloworld.HelloRequest, oracle.demo.grpc.protobuf.helloworld.Helloworld.HelloReply> getSayHelloMethod;
    if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
      synchronized (GreeterGrpc.class) {
        if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
          GreeterGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<oracle.demo.grpc.protobuf.helloworld.Helloworld.HelloRequest, oracle.demo.grpc.protobuf.helloworld.Helloworld.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  oracle.demo.grpc.protobuf.helloworld.Helloworld.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  oracle.demo.grpc.protobuf.helloworld.Helloworld.HelloReply.getDefaultInstance()))
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((oracle.demo.grpc.protobuf.helloworld.Helloworld.HelloRequest) request,
              (io.grpc.stub.StreamObserver<oracle.demo.grpc.protobuf.helloworld.Helloworld.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class GreeterBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return oracle.demo.grpc.protobuf.helloworld.Helloworld.getDescriptor();
    }
