...
public class FaultToleranceResource {
    ...
    // 1024 is overwited to 3 by config file: com.example.ft.FaultToleranceResource/bulkhead/Bulkhead/value=3
    @Bulkhead(1024) 
    @GET @Path("/bulkhead")
    ...
    // java -cp ./target/helidon-mp-demo.jar com.example.ft.FaultToleranceTester <n>
}
